...
def Convert():
    ...
    fea_cfg.setcfg(fea_dim=fea_dim, state_num=state_num, utt_num=file_count, fea_num_total=fea_num_total, fea_mean=fea_mean_total, fea_var=fea_var_total)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--feascp',
        type=str,
        default='/Users/hadoop/Documents/python/PythonSlv/tf/kaldi/train/train.scp',
        help='Feature Scp File Path'
    )
    parser.add_argument(
        '--aliscp',
        type=str,
        default='/Users/hadoop/Documents/python/PythonSlv/tf/kaldi/train/train.pdf',
        help='Align Scp File Path'
    )
    parser.add_argument(
        '--tffd',
        type=str,
        default='/Users/hadoop/Documents/python/PythonSlv/tf/train',
